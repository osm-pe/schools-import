...
module.exports = function() {
    ...
    map.on('click', config.layerId, function(e) {
        var html = "<div class='pill'> <a id='start' href='#' class='col12 button'>Start Mapping in JOSM</a> " +
            " <a id='done' href='#' class='col12 button'>Mark task as done</a> " +
            " <a href='#' class='col12 button'>Validate</a></div>"
        if (!user) {
